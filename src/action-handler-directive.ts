...
customElements.define('action-handler-electricity-schedule', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-electricity-schedule')) {
    return body.querySelector('action-handler-electricity-schedule') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-electricity-schedule');
